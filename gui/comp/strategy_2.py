...
from gui.comp import constants
from gui.comp.constants import CARDS
from gui.comp.entity import Game
from gui.comp.util import common_util
from gui.comp.util.poker_util import deal_cards
from gui.comp.util.poker_value import best_cards
...
class Strategy:
    ...
    def strategy_1(self, episode, catzzz_first_action_flag):
        ...
        核心策略函数
        :param episode: 当前对局数
        :param catzzz_first_action_flag: 本阶段是否需要我方先行动
        :return: [str] 策略动作指令（博弈比赛平台规定的指令）
        """
