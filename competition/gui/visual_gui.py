...
class GUI:
    def __init__(self, name):
        ...
        self.interface()
        self.socket = connect_server(name)
    ...
    def interface(self):
        ...
        self.client_send = tk.Button(self.root, text="发送指令", command=self.send_cmd_event)
        self.client_send.pack()
